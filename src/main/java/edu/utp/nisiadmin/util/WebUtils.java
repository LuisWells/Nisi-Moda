package edu.utp.nisiadmin.util;
...
public class WebUtils {
    ...
    public static boolean isRequiredField(final Object dto, final String fieldName) {
        boolean result;
        try {
            return dto.getClass().getDeclaredField(fieldName).getAnnotation(NotNull.class) != null || dto.getClass().getDeclaredField(fieldName).getAnnotation(NotBlank.class) != null;
